...
class AssignController extends Controller
{
    public function first(Request $request)
    {
        ...
        $first = Employee::where('emp_name','Austyn Kuhic')->first();
        echo $first->emp_name;
    }
    ...
    public function value(Request $request)
    {
        ...
        // $value = Employee::where('emp_name','Dr. Kennedi Torphy')->value('emp_address');
        // return $value;
        // $result = Employee::create(
        //     ['emp_name'=>'Ms.Burma',
        //     'emp_ph'=>'123456',
        //     'emp_pwd'=>'hello',
        //     'emp_email'=>'burma@gmail.com',
        //     'emp_address'=>'Yangon',
        //     'created_by'=>'4',
        //     'updated_by'=>'3'
        // ]);
    ...
    {
        $select = DB::table('assign')->select('title','employee_id as empId')->get();
        // return $select;

        // $query = DB::table('assign')->select('title');
        $query = Assign::select('title');
